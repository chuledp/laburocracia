...
## Diagrama de conexión (formato ASCII)

> **Nota:** Este diagrama se ve correctamente en GitHub gracias al bloque `plaintext`. Copia el esquema respetando la fuente monoespaciada.

```plaintext
Raspberry Pi GPIO 18 (PWM0)  ──── 220Ω ────┐
                                            │
                                         ┌──┴──┐
                                         │     │
                                         │ G   │
